...
// We use this page for users to submit campus activities.
// checking wallet and profile before the user can submit.
    ...
    <>
      <SubmitTaskForm
        ...
        onSubmit={async (formData) => {
          ...
          // We upload the proof file to IPFS and then save the activity on-chain.
          await submitTask({
      ...
      <ProfileGateDialog
        ...
        onClose={() => router.push("/")}
        onSave={async (input) => {
          // We save the profile first, then let the user continue.
